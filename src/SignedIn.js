...
class SignedIn extends Component {
  ...
  render() {
    ...
    if (window.location.pathname === '/') {
      return <Redirect to={`/kingdom/${username}`} />;
    }
    ...
    return (
      <div className="SignedIn">
        ...
        <Switch>
          <Route
            path="/animals"
            render={routeProps => <OptionsList type="animals" {...routeProps} />}
          />
          <Route
            path="/territories"
            render={routeProps => <OptionsList type="territories" {...routeProps} />}
          />
          <Route
            path="/others"
            render={routeProps => <OtherKingdoms type="territories" {...routeProps} />}
          />
          <Route
            path="/me"
            render={routeProps => (
